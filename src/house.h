...
public:
	...
	//[[--Darghos
	void setPendingExpropriation(bool _pendingExpropriation) {pendingExpropriation = _pendingExpropriation;}
	bool getPendingExpropriation() const {return pendingExpropriation;}
	//--]]
