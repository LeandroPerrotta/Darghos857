function onSay(cid, words, param)
	...
	if (getPlayerBless(cid, 0) == TRUE) and (getPlayerBless(cid, 1) == TRUE) and (getPlayerBless(cid, 2) == TRUE) and (getPlayerBless(cid, 3) == TRUE) and (getPlayerBless(cid, 4) == TUE) then
