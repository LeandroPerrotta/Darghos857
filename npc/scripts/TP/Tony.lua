local keywordHandler = KeywordHandler:new()
        ...
        local travelNode1 = keywordHandler:addKeyword({'arena'}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 0, destination = {x=493, y=653, z=7}, msg = 'Be careful. Lots of wild and strange animals run around there.'})

        local travelNode2 = keywordHandler:addKeyword({'foreign'}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 0, destination = {x=493, y=660, z=7}})
